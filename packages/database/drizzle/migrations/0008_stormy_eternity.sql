...
ALTER TABLE "artist_handle_histories" ADD CONSTRAINT "artist_handle_histories_changed_by_user_id_users_id_fk" FOREIGN KEY ("changed_by_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "artist_handle_histories_artist_created_idx" ON "artist_handle_histories" USING btree ("artist_id","created_at");