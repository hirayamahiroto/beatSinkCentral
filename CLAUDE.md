...
| やること                                                                                                            | Skill                                     | 備考                                                                                                                                                                                                                                                         |
| ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 新しい施策・機能群の実装計画を立てる                                                                                | `task-breakdown`                          | **新施策は必ずここから**。要件（PRD）→ UI 体験設計（課題をどの UI 動線で解決するか議論する）→ 画面設計（UI 契約の凍結）→ ログ・計測設計 → インターフェース設計（API/BFF 対応表）→ タスク分解、の順を**すべて**踏む。途中の工程を飛ばしてタスク分解へ進まない |
